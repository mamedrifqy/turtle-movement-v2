  ...
  return (
    <div className="creditsWrapper">
      <div className="creditsHeader u-desktopHidden">
        <h1>Migration paths of some turtles</h1>
      ...
      <div className="credits">
        ...
        <p className="u-mobileHidden">
          Turtle pictures: <a href="https://commons.wikimedia.org">WikiMedia Commons</a>
        </p>
        <p>
        ...
        <p>
          Author: <a href="https://mamedrifqy.github.io/">Muhammad Rifqy</a>.
        </p>
      </div>
    </div>
  )
